...
export default function Analysis({
  ...
  return (
    <div className="clash-panel mb-8">
      ...
      {analysis.deckOverview && <DeckOverview deckOverview={analysis.deckOverview} />}
      {analysis.deckOverview && <CardRoles cardRoles={analysis.deckOverview.cardRoles} deck={deck} />}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <AnalysisSection title="Synergies" icon="S" items={analysis.synergies} color="clash-purple" handleSynergyHover={handleSynergyHover} />
      </div>
